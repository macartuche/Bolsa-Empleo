...
class BarPlot extends Plot {
    ...
    public $grad_fromcolor=array(46,139,87),$grad_tocolor=array(255,255,255);
    public $ymin=0;
    ...
    protected $bar_3d_hsize=5,$bar_3d_vsize=5;
    ...
    function SetShadow($aColor="black",$aHSize=5,$aVSize=5,$aShow=true) {
    ...
    function Set3D($aHSize=5,$aVSize=5,$aShow=true) {
        $this->bar_3d=$aShow;
