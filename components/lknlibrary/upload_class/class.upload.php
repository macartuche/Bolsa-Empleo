...
class upload {
            ...
            if (!$this->file_src_mime || !is_string($this->file_src_mime) || empty($this->file_src_mime) || strpos($this->file_src_mime, '/') === FALSE) {
                if ($this->mime_magic) {
                    ...
                    if (function_exists('mime_content_type')) {
                        ...
                        $this->file_src_mime=$this->mime_content_type_overwrite($this->file_src_name);
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            $this->file_dst_name_ext    = strtolower($this->file_src_name_ext);
	...
	function mime_content_type_overwrite($filename) {
