...
<div style="margin:20px;" class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
<?php echo $this->escape($this->params->get('page_title')); ?>
</div>
<?php endif; ?>
<div style="margin:20px; border:#EFEFEF 1px solid;" class="contentpane<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color:aliceblue;">
	<thead>
		<tr>
			<td align="right" colspan="6" style="background-color:aquamarine;">
