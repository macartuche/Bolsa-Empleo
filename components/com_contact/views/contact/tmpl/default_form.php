		...
		function validateForm( frm ) {
			...
			if (valid == false) {
				...
				if (frm.email.invalid) {
					alert( "' . JText::_( 'Por favor, ingrese un correo electrónico valido.', true ) . '" );
...
<tr>
	...
	<form action="<?php echo JRoute::_( 'index.php' );?>" method="post" name="emailForm" id="emailForm" class="form-validate">
		<div class="contact_email<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" style="text-align:left; margin:10px;">
