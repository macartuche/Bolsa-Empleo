	...
	//			print_r($row);
			...
			if ($k=='1') {
				...
				$class='jl_even_row';
						...
						if ($spend_action=='1') {
							...
							$job_created=lknDate::formatDate($date);
							$credits=$row->credits;
							if ($type=='2') {
								$credits=lknJobsFunctions::getPackageName($credits,'2') . ' (' . $credits . ')';
							}
		...
		<?php if ($package_id!='') {?>
			<div class="floatRight">
				<a class="btn" href="<?php echo $remove_filter_url;?>"><?php echo _lkn_credit_speding_history_remove_filter;?></a>
			</div>
		<?php }?>