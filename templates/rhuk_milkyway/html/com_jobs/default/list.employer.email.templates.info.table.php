...
?>
			...
			<tbody><tr>
				...
				<td width="48%"><?php echo _lkn_employer_info_table_email_template_published;?></td>
				<td width="2%"><img alt="inactive" src="<?php echo TEMPLATE_IMAGE_PATH. "published_x.gif";?>"/></td>
				<td width="48%"><?php echo _lkn_employer_info_table_email_template_published_x;?></td>
			</tr>
			<tr>
				<td><img alt="read" src="<?php echo TEMPLATE_IMAGE_PATH. "edit.gif";?>"/></td>
				<td><?php echo _lkn_employer_info_table_email_template_edit;?></td>
				<td><img alt="unread" src="<?php echo TEMPLATE_IMAGE_PATH. "delete.gif";?>"/></td>
				<td><?php echo _lkn_employer_info_table_email_template_delete;?></td>
			</tr>
		</tbody></table>